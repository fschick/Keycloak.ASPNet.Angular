...
internal static class AuthorizationStartup
{
    ...
    {
        services.AddTransient<RealmRoleTransformation, RealmRoleTransformation>();
        services.AddTransient<ClientRoleTransformation, ClientRoleTransformation>();
        services.AddTransient<RptRoleTransformation, RptRoleTransformation>();
        services.AddTransient<IClaimsTransformation, KeycloakJwtTransformation>();
    }
